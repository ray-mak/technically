...
const JourneySteps = () => {
  return (
    <section className="bg-custom grid gap-8 rounded-xl bg-neutral-100 px-4 py-16 text-neutral-900 md:gap-12 md:px-8 md:py-20 lg:justify-items-center lg:gap-16 lg:px-16">
